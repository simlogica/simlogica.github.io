...
Yes, all data is stored locally on your device and protected by Android's system. We do not upload your personal data to any server. Read more in our [Privacy Policy](privacy.md).

### How do I configure the necessary Android Permissions?

Read our [extremely easy guide](configure.md) on that.
...
If you want Blocker not to intercept calls for some time, go to **Settings → Default Apps → Caller ID and Antispam App** and chose **None**.

<img src="/assets/screen3.png" style="max-width: 40%; height: auto;" alt="Blocker requesting Contacts access permission">
